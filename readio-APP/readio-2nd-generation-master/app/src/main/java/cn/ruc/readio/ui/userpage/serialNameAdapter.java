...
public class serialNameAdapter extends BaseAdapter {
    private final Context context;
    private final onItemViewClickListener listener;
    private List<String> list;

    public serialNameAdapter(Context context, List<String> list, onItemViewClickListener listener) {
    ...
    public View getView(final int position, View convertview, ViewGroup parent) {
        ...
        if (convertview == null) {
            ...
            convertview = LayoutInflater.from(context).inflate(R.layout.item_serialname, null);
